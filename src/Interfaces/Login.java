...
public class Login extends javax.swing.JFrame {
    ...
    //clase de arranque del JFRAME
    public Login() {
        //Borra la barra de windows
        setUndecorated(true);
        initComponents();
        pack();
        setLocationRelativeTo(null);
        //listener para funcion del boton salir
...
//boton para entrar al programa
    private void BTN_entrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_entrarActionPerformed
        //llamando a la clase a su clase dao
        DAOlogin dao = new DAOlogin(cn);
        
        String usuario = TXT_usuario.getText();
        String clave = new String(TXT_clave.getPassword());
        
        //Booleano para verificar el si retorna correcto o no la clase Validar usuario
        boolean verificacion = dao.ValidarUsuario(usuario, clave);
        
        if(verificacion == true){
            //siendo verdardadero se crea la nueva pantalla menu principal 
